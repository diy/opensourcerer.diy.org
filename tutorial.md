...
### Navigate to Folder
Let's create a folder that will hold all of our code files. Bash is starting us at the root of our computer, but let's move into our Documents folder.

![root](http://diy-visualpedia.s3.amazonaws.com/folder-nav-01.png)
...
Now we're inside the Documents folder. 

![documents](http://diy-visualpedia.s3.amazonaws.com/folder-nav-02.png)

Let's create a new folder with **mkdir** - *make directory*, get it?
...
![myCode](http://diy-visualpedia.s3.amazonaws.com/folder-nav-03.png)

Now we've made a folder called myCode inside our Documents folder. Let's put the DIY files in it!

### Clone the Repo
We want to tell Git to go to the place on the internet where Github is storing our forked files and clone them to where we are right now inside of the myCode folder. Each repo on github has an address for its location. You'll see it following the HTTP and SSH buttons near the top middle of the page. Click on HTTP, this is the address you'll use. 
...
![open-sourcerer](http://diy-visualpedia.s3.amazonaws.com/folder-nav-04.png)
